...
numTotal = 1000 %100 %10000;     % number of samples totally       %%%%%改原10000
ratio_Trn = 0.9 %0.8;

% data folder:
folder0 = ['d_CIFAR10_DVS_sz',num2str(size1), '_',num2str(numTotal), '_trn',num2str(ratio_Trn,'%0.2f'), ...
...
CINsfile = [folder0, '/', 'CIFAR10-DVS.mat'];%cifar10-dvs
if ( (reRunAll) || (reGenCINs) || ~exist(CINsfile,'file') )
    ...
    [NumCINs]=prepareCINs_CIFAR10_DVS(folder0,sourceMatFile);
end
