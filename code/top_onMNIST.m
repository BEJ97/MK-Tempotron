...
% data folder:
folder0 = ['d_MNIST_nRpt',num2str(nRepeat), '_4x4filt',str1,maxStr,num2str(post_proc_th),...
...
CINsfile = [folder0, '/', 'AER_MNISTbRand_500_alt.mat'];
if ( (reRunAll) || (reGenCINs) || ~exist(CINsfile,'file') )
    run_img2aer_motion (d, ratio, folder0,nRepeat);
end
